         ...
         <!-- SIDEBAR -->
			<div class="sidebar" style="width: 300px; background-color:#B6D8EC">
				<div class="sidebar-background">
					<h2 class="logo-text">
                                            <span style="display: block;" class="tag">Welcome: </span><span class="val"><%=user.getFirstName()+" " %><%=user.getLastName() %></span>
					</h2>
           ...
           <%
               ...
               <div class="central-div form-style-6" style="position:inherit;margin-top: 70px;" >
                    <form action="controller.jsp"  onsubmit="return keyDown(event);">
				...
				<table>
					...
					<tr>
						...
						<td>
                                                    <input required type="text" name="fname" value="<%=user.getFirstName() %>" class="text" placeholder="First Name">
						</td>
					</tr>
					<tr>
						<td>
						...
						<td>
                                                    <input required type="text"  name="lname" value="<%=user.getLastName() %>" class="text" placeholder="Last Name">
						</td>
					</tr>
					...
					<tr>
						...
						<td>
                                                    <input required type="text" name="uname" value="<%=user.getUserName() %>" class="text" placeholder="User Name">
						</td>
					</tr>
					<tr>
						<td>
						...
						<td>
                                                    <input required type="email" name="email" value="<%=user.getEmail() %>" class="text" placeholder="Email">
						</td>
					</tr>
					...
					<tr>
						...
						<td>
                                                    <input required type="password" value="<%=user.getPassword() %>" name="pass" class="text" placeholder="Password">
						</td>
					</tr>
                                        <tr>
						<td>
						...
						<td>
                                                    <input required type="text" name="contactno" value="<%=user.getContact() %>" class="text" placeholder="Contact No">
						</td>
					</tr>
                                        <tr>
						<td>
						...
						<td>
                                                    <input required type="text" name="city" value="<%=user.getCity() %>" class="text" placeholder="City">
						</td>
					</tr>
                                        <tr>
						<td>
						...
						<td>
                                                    <input required type="text" name="address" value="<%=user.getAddress() %>" class="text" placeholder="Address">
						</td>
					</tr>
					<tr>
						<td>
