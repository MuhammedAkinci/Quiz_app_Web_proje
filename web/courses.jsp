...
<!-- SIDEBAR -->
			<div class="sidebar" style="width: 20%; background-color:#B6D8EC">
				<div class="sidebar-background">
					<h2 class="logo-text">
						<span style="display: block;" class="tag">Welcome: </span><span class="val">aziz amiraslanov</span>
					</h2>
    ...
    <thead>
        ...
        <div  class="panel form-style-6" style="max-width: 650px" >
           <div class="title">
                                   Add New Course
                                </div>
            <center>
